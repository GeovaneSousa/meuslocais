...
@ManagedBean
@ViewScoped
public class MapaCompleto implements Serializable {
    ...
    public void init() {
        ...
        for (Local a : locaisParaOMapa) {

            coord = new LatLng(a.getLatitude(),
                    a.getLongitude());
            mapaAvancado.addOverlay(new Marker(coord, a.getRotulo(), null,
